...
--// Libraries
local ReGui = loadstring(game:HttpGet('https://raw.githubusercontent.com/hookop/regui/refs/heads/main/Main.luau'), "ReGui")()
	...
	self:CreateButtons(Tab, {
		...
		Buttons = {
			...
			},
			{
				Text = "Copy Github",
				Callback = function()
					self:SetClipboard("https://github.com/x7dJJ9vnFH23/Dear-ReGui")
				end,
			},
			{
				Text = "Edit Spoofs",
